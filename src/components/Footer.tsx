  ...
  return (
    <>
      ...
      >
        ...
        <path
          className="wave-path"
          d="M0,40 Q300,0 600,40 T1200,40 L1200,60 L0,60 Z"
          fill="#F97316"
        />
      </svg>

      <footer className="bg-orange-500 pb-12 px-4">
        <div className="mx-auto max-w-6xl flex flex-col md:flex-row items-center justify-between gap-8 pt-8">
        ...
        <div className="text-white/80 text-sm text-center md:text-right">
          <p>© 2025 Kulitmu</p>
          <p className="text-white/60">Dibuat dengan ❤️ untuk kulit Anda</p>
        </div>
        </div>
      </footer>
    </>
